...
for i in 1:10
	for j in 1:33
		means[i,j]=mean(ergebnis[1:10*i,i,j])
		variances[i,j]=std(ergebnis[1:10*i,i,j])^2
	end
end

# ╔═╡ 33b89886-2586-4fe2-8420-b95f86bcf40a
scatter([10*i for i in 1:10],variances[:,2],xlabel="particles",ylabel="variance",title="variance, 33-D hybrid-rosenbrock")
